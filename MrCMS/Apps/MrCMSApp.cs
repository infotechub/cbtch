...
namespace MrCMS.Apps
{
    public abstract class MrCMSApp
    {
        ...
        {
            MrCMSAppRegistrationContext context = new MrCMSAppRegistrationContext(this.AppName, routes, state);
