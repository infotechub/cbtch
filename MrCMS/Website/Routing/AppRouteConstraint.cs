...
namespace MrCMS.Website.Routing
{
    public class AppRouteConstraint : IRouteConstraint
    {
        ...
        public bool Match(HttpContextBase httpContext, Route route, string parameterName, RouteValueDictionary values, RouteDirection routeDirection)
        {
            ...
            {
                MrCMSControllerFactory mrCMSControllerFactory = ControllerBuilder.Current.GetControllerFactory() as MrCMSControllerFactory;
            ...
            Dictionary<string, HashSet<Type>> controllers = isAdmin
