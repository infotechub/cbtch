...
namespace MrCMS.Search
{
    public class UniversalSearchIndexManager : IUniversalSearchIndexManager
    {
        ...
        public Directory Directory { get => Directory1; set => Directory1 = value; }
        public Directory Directory1 { get => _directory; set => _directory = value; }
        public Directory Directory2 { get => _directory; set => _directory = value; }
        ...
        public void Insert(SystemEntity entity)
        {
            ...
            UniversalSearchIndexData data = new UniversalSearchIndexData
            {
        ...
        {
            using (IndexWriter indexWriter = new IndexWriter(GetDirectory(_site), GetAnalyser(), recreateIndex,
