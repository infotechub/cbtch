...
namespace MrCMS.Search.ItemCreation
{
    public class GetUserSearchItem : GetUniversalSearchItemBase<User>
    {
        ...
        {
            Dictionary<User, HashSet<string>> primaryDictionary = new Dictionary<User, HashSet<string>>();
            ...
            Dictionary<User, HashSet<string>> secondaryDictionary = new Dictionary<User, HashSet<string>>();
            foreach (IGetUserSearchTerms userSearchTerms in _userSearchTerms)
            {
