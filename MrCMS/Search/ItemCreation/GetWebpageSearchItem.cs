...
namespace MrCMS.Search.ItemCreation
{
    public class GetWebpageSearchItem : GetUniversalSearchItemBase<Webpage>
    {
        ...
        {
            Dictionary<Webpage, HashSet<string>> primaryDictionary = new Dictionary<Webpage, HashSet<string>>();
            ...
            Dictionary<Webpage, HashSet<string>> secondaryDictionary = new Dictionary<Webpage, HashSet<string>>();
            foreach (IGetWebpageSearchTerms webpageSearchTerms in _getWebpageSearchTerms)
            {
