...
namespace MrCMS.Search.ItemCreation
{
    public class GetLayoutSearchItem : GetUniversalSearchItemBase<Layout>
    {
        ...
        {
            Dictionary<Layout, HashSet<string>> primaryDictionary = new Dictionary<Layout, HashSet<string>>();
            Dictionary<Layout, HashSet<string>> secondaryDictionary = new Dictionary<Layout, HashSet<string>>();
