...
namespace MrCMS.Entities.Documents.Web
{
    public abstract class Webpage : Document
    {
        ...
        //Added by Tony
        [DisplayName("Show Link only if permitted.")]
        public virtual bool ShowOnlyIfPermitted { get; set; }

        [DisplayName("The Font awesome Icon for the link")]
