...
namespace MrCMS.Services
{
    public class FileService : IFileService
    {
        ...
        public virtual string GetUrl(MediaFile file, Size size)
        {
            ...
            IList<ResizedImage> resizedImages = _session.QueryOver<ResizedImage>().Where(image => image.MediaFile.Id == file.Id).Cacheable().List();
        ...
        {
            ResizedImage resizedImage = new ResizedImage { Url = requestedImageFileUrl, MediaFile = file };
        ...
        public string GetFileUrl(string value)
        {
            ...
            MediaFile file = _session.Get<MediaFile>(id);
            ImageSize imageSize =
