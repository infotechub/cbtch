...
namespace MrCMS.Helpers
{
    public static class PagingHelper
    {
                                           ...
                                           Func<int, object> getRouteValues, string format)
        {
            ...
            string url = html.ActionWithCurrentQueryString(actionName, getRouteValues(targetPageNumber));
        ...
        {
            int targetPageNumber = list.PageNumber - 1;
            string url = html.UrlWithCurrentQueryString(GetCurrentPath(html), getRouteValues(targetPageNumber));
            return PreviousItem(html, list, url, getRouteValues, format);
        }
        ...
        {
            string url = html.ActionWithCurrentQueryString(actionName, getRouteValues(i));
        ...
        private static TagBuilder Page(HtmlHelper html, int i, IPagedList list,
                                       ...
                                       Func<int, string> format)
        {
            string url = html.UrlWithCurrentQueryString(GetCurrentPath(html), getRouteValues(i));
            return PageItem(html, i, list, url, getRouteValues, format);
        }
                                           ...
                                           Func<int, string> format)
        {
            ...
            bool currentPage = i == list.PageNumber;
            if (currentPage)
        ...
        private static TagBuilder Next(HtmlHelper html, IPagedList list, string actionName,
                                       Func<int, object> getRouteValues, string format)
        {
            string url = html.ActionWithCurrentQueryString(actionName, getRouteValues(list.PageNumber + 1));
        ...
        private static TagBuilder Next(HtmlHelper html, IPagedList list,
                                       Func<int, object> getRouteValues, string format)
        {
            string url = html.UrlWithCurrentQueryString(GetCurrentPath(html), getRouteValues(list.PageNumber + 1));
            return NextItem(html, list, url, getRouteValues, format);
        }
        ...
        private static TagBuilder Last(HtmlHelper html, IPagedList list, string actionName,
                                       Func<int, object> getRouteValues, string format)
        {
            string url = html.ActionWithCurrentQueryString(actionName, getRouteValues(list.PageCount));
        ...
        private static TagBuilder Last(HtmlHelper html, IPagedList list, 
                                       Func<int, object> getRouteValues, string format)
        {
            string url = html.UrlWithCurrentQueryString(GetCurrentPath(html), getRouteValues(list.PageCount));
            return LastItem(html, list, url, getRouteValues, format);
        }
