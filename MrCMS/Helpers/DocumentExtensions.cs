...
namespace MrCMS.Helpers
{
    public static class DocumentExtensions
    {
        ...
        {
            DocumentVersion documentVersion = doc.Versions.FirstOrDefault(version => version.Id == id).Unproxy();
        ...
        {
            List<VersionChange> changes = new List<VersionChange>();

            if (previousVersion == null)
                return changes;

            List<PropertyInfo> propertyInfos = currentVersion.GetType().GetVersionProperties();
        ...
        {
            Document document = currentVersion.Document.Unproxy();
            Document previousVersion = DeserializeVersion(currentVersion, document);
        ...
        {
            string[] ignorePropertyNames = new[]
                                          {
