...
namespace MrCMS.Helpers
{
    public static class SessionHelper
    {
        ...
        {
            MrCMSSession session = new MrCMSSession(sessionFactory.OpenSession(), context);
            ...
            where T : SystemEntity
        {
            ...
            int rowCount = query.GetExecutableQueryOver(session).ToRowCountQuery().SingleOrDefault<int>();
