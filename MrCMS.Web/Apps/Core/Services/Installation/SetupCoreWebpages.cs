    ...
    public class SetupCoreWebpages : ISetupCoreWebpages
    {
        ...
        public void Setup()
        {
            _session.Transact(session =>
            {
                ...
                SiteSettings siteSettings = _configurationProvider.GetSiteSettings<SiteSettings>();
                ...
                IList<Webpage> webpages = _session.QueryOver<Webpage>().List();
                System.DateTime publishOn = CurrentRequestData.Now;
        ...
        {
            TextPage error403 = new TextPage
            {
                Name = "403",
                UrlSegment = "403",
            ...
            TextPage error404 = new TextPage
            {
                Name = "404",
                UrlSegment = "404",
            ...
            TextPage error500 = new TextPage
            {
                Name = "500",
                UrlSegment = "500",
        ...
        {
            TextPage homePage = new TextPage
            {
                Name = "Home",
                UrlSegment = "home",
                BodyContent =
            ...
            //contact us
            TextPage contactUs = new TextPage
            {
                Name = "Contact us",
        ...
        private void AddFormToContactUs(Webpage contactUs)
        {
            ...
            TextBox fieldEmail = new TextBox
            {
                Name = "Email",
