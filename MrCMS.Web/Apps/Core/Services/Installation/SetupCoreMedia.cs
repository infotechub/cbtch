...
namespace MrCMS.Web.Apps.Core.Services.Installation
{
    public class SetupCoreMedia : ISetupCoreMedia
    {
        ...
        public void Setup()
        {
            ...
            {
                MediaCategory defaultMediaCategory = new MediaCategory
                {
                    Name = "Default",
                    UrlSegment = "default",
                };
                session.Save(defaultMediaCategory);
                MediaSettings mediaSettings = _configurationProvider.GetSiteSettings<MediaSettings>();
                ...
                FileStream fileStream = new FileStream(logoPath, FileMode.Open);
                ...
                FileStream fileStream1 = new FileStream(logoPath1, FileMode.Open);
