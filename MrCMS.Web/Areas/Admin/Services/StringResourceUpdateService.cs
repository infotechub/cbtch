...
namespace MrCMS.Web.Areas.Admin.Services
{
    public class StringResourceUpdateService : IStringResourceUpdateService
    {
        ...
        {
            IEnumerable<StringResource> resources = _provider.AllResources.GetResourcesByKeyAndValue(searchQuery);
            ...
            foreach (StringResource source in resources.OrderBy(resource => resource.Key))
            {
        ...
        public ResourceImportSummary Import(HttpPostedFileBase file)
        {
            ...
            List<StringResourceData> resourceData = new List<StringResourceData>();
