...
namespace MrCMS.Web.Areas.Admin.Services
{
    public class ACLService : IACLService
    {
        ...
        public void UpdateACL(List<ACLUpdateRecord> model)
        {
            ...
            {
                foreach (ACLUpdateRecord aclUpdateRecord in model)
                {
                    Entities.People.UserRole role = _roleService.GetRoleByName(aclUpdateRecord.Role);

                    ACLRole aclRole = role.ACLRoles.FirstOrDefault(ar => ar.Name == aclUpdateRecord.Key);
                    ...
                    {
                        ACLRole newRole = new ACLRole { UserRole = role, Name = aclUpdateRecord.Key };
