...
namespace MrCMS.Web.Areas.Admin.Services.SEOAnalysis
{
    public class TargetTermIsUnique : BaseSEOAnalysisFacetProvider
    {
        ...
        {
            IList<Webpage> anyWithSameTitle =
            ...
            {
                List<string> messages = new List<string> { "The target term is not unique, you should consider differentiating it from other pages within your site" };
                messages.AddRange(
