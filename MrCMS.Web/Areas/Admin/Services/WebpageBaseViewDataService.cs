...
namespace MrCMS.Web.Areas.Admin.Services
{
    public class WebpageBaseViewDataService : IWebpageBaseViewDataService
    {
        ...
        public void SetAddPageViewData(ViewDataDictionary viewData, Webpage parent)
        {
            ...
            List<PageTemplate> templates = _getValidPageTemplatesToAdd.Get(validWebpageDocumentTypes);

            List<DocumentTypeToAdd> documentTypeToAdds = new List<DocumentTypeToAdd>();
